  class UI {
      ...
      loadData() {
          this.table.DataTable({
              processing: true,
              serverSide: true,
              ajax: process_env_url + "/table/master/radikalisme",
              columns: [{
                      data: 'DT_RowIndex',
                      name: 'id'
                  },
                  {
                      data: 'deskripsi_radikalisme',
                      name: 'deskripsi_radikalisme'
                  },
                  {
                      data: 'action',
                      name: 'action'
      ...
      async submitData() {
          ...
          const url = process_env_url + "/simpan/master/radikalisme";
          let datas = {
              deskripsi: deskripsi,
              id: id
          };
      ...
      /* Delete Data */
      deleteData(element) {
          const url = process_env_url + '/hapus/master/radikalisme/' + element.dataset.id;
          swal({
                  title: "Are you sure?",
                  text: "Ingin Menghapus? , anda akan kehilangan data master radikalisme!",
                  icon: "warning",
                  buttons: true,
                  dangerMode: true,
              })
      ...
      editData(element) {
          ...
          this.title.textContent = 'Edit Master radikalisme';
          this.modals.modal({
              backdrop: 'static'
          });
      }
  ...
  document.addEventListener('DOMContentLoaded', function () {
      ...
      ui.buttonTambah.addEventListener('click', function () {
          ui.title.textContent = 'Tambah Master radikalisme';
          ui.modals.modal({
              backdrop: 'static'
          });
      });
