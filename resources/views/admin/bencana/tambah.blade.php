        ...
        <div class="col-md-12 grid-margin">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">FORM TAMBAH bencana</h3>
                    ...
                    <form action="" method="post" id="formSubmit" onclick="event.preventDefault()">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6" >
                                ...
                                <input type="text" class="form-control" name="bencana" id="bencana" maxlength="100" placeholder="Masukkan nama bencana"  >
                                ...
                                foreach ($bulan as $b) {
                                   ?>
                                    <div class="form-group col-md-2" >
                                        ...
                                        <input type="number" class="form-control" name="{{$b}}" id="{{$b}}" maxlength="100" placeholder="Masukkan total bencana bulan {{$b}}"  >
                        ...
                        <button type="submit" class="btn btn-primary btn-md col-md-12" id="btn-tambah"><i
                                class="fa fa-plus"></i> Tambah Peta bencana</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', async function() {
        $('#btn-tambah').click( async function() { 
            ...
            const url = process_env_url+"/simpan/bencana";
            try {
