                    ...
                    <form action="" method="post" id="formSubmit" onclick="event.preventDefault()">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6" >
                                ...
                                <input type="text" class="form-control" name="kebangsaan" id="kebangsaan" maxlength="100" placeholder="Masukkan Kebangsaan"  >
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="maksud" id="maksud" class="form-control">
                                    ...
                                    <option value="Kunjungan Bisnis/Keluarga/Social">Kunjungan Bisnis/Keluarga/Social</option>
                                    <option value="Pendidikan/Studi/Kuliah">Pendidikan/Studi/Kuliah</option>
                             ...
                             <div class="form-group col-md-6" >
                                ...
                                <input type="text" class="form-control" name="tgl" id="tgl" maxlength="100" readonly placeholder="Masukkan Tanggal SKT"  >
                                <small class="text-danger tgl"></small>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="lama">Lama Tinggal</label>
                                <input type="text" name="lama" id="lama" class="form-control" placeholder="...Hari">
                        ...
                        <button type="submit" class="btn btn-primary btn-md col-md-12" id="btn-tambah"><i
                                class="fa fa-plus"></i> Tambah Peta asing</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', async function() {
        $('#btn-tambah').click( async function() { 
            ...
            const url = process_env_url+"/simpan/asing";
            try {
