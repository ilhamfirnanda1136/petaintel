        ...
        <div class="col-md-12 grid-margin">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">FORM TAMBAH PETA KONFLIK SOSIAL</h3>
                    ...
                    <form action="" method="post" id="formSubmit" onclick="event.preventDefault()">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="konflik" id="konflik" class="form-control" >
                                    @foreach($konflik as $k)
                                        <option value="{{$k->id}}">{{$k->deskripsi_konflik}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6" >
                                ...
                                <input type="text" class="form-control" name="judul" id="judul" maxlength="100" placeholder="Masukkan Judul"  >
                        ...
                        <button type="submit" class="btn btn-primary btn-md col-md-12" id="btn-tambah"><i
                                class="fa fa-plus"></i> Tambah Peta Konflik</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', async function() {
        $('#btn-tambah').click( async function() { 
            ...
            const url = process_env_url+"/simpan/konflik";
            try {
