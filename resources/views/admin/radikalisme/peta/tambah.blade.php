        ...
        <div class="col-md-12 grid-margin">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">FORM TAMBAH PETA RADIKALISME SOSIAL</h3>
                ...
                <div class="card-body">
                    <form action="" method="post" id="formSubmit" onclick="event.preventDefault()">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="radikalisme" id="radikalisme" class="form-control" >
                                    @foreach($radikalisme as $k)
                                        <option value="{{$k->id}}">{{$k->deskripsi_radikalisme}}</option>
                                    @endforeach
                                </select>
                        ...
                        <button type="submit" class="btn btn-primary btn-md col-md-12" id="btn-tambah"><i
                                class="fa fa-plus"></i> Tambah Peta radikalisme</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', async function() {
        $('#btn-tambah').click( async function() { 
            ...
            const url = process_env_url+"/simpan/radikalisme";
            try {
