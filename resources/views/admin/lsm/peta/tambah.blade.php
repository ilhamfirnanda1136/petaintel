        ...
        <div class="col-md-12 grid-margin">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">FORM TAMBAH PETA LSM ORMAS SOSIAL</h3>
                ...
                <div class="card-body">
                    <form action="" method="post" id="formSubmit" onclick="event.preventDefault()">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="lsm" id="lsm" class="form-control" >
                                    @foreach($lsm as $k)
                                        <option value="{{$k->id}}">{{$k->deskripsi_lsm}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6" >
                                ...
                                <input type="text" class="form-control" name="nama" id="nama" maxlength="100" placeholder="Masukkan nama"  >
                            ...
                            <div class="form-group col-md-6" >
                                ...
                                <input type="text" class="form-control" name="kedudukan" id="kedudukan" maxlength="100" placeholder="Masukkan kedudukan"  >
                                <small class="text-danger kedudukan"></small>
                            </div>   
                             <div class="form-group col-md-6" >
                                <label for="tgl_berdiri">Tgl Berdiri</label>
                                <input type="date" class="form-control" name="tgl_berdiri" id="tgl_berdiri"  >
                                <small class="text-danger tgl_berdiri"></small>
                            </div>
                            <div class="form-group col-md-6" >
                                <label for="pengurus">Pengurus</label>
                                <input type="text" class="form-control" name="pengurus" id="pengurus" maxlength="100" placeholder="Masukkan pengurus"  >
                                <small class="text-danger pengurus"></small>
                            </div>   
                             <div class="form-group col-md-6" >
                                <label for="ruanglingkup">Ruang Lingkup</label>
                                <input type="text" class="form-control" name="ruanglingkup" id="ruanglingkup"  placeholder="Masukkan Ruang lingkup">
                                <small class="text-danger ruanglingkup"></small>
                            </div>   
                            <div class="form-group col-md-6">
                        ...
                        <button type="submit" class="btn btn-primary btn-md col-md-12" id="btn-tambah"><i
                                class="fa fa-plus"></i> Tambah Peta lsm</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', async function() {
        $('#btn-tambah').click( async function() { 
            ...
            const url = process_env_url+"/simpan/lsm";
            try {
